...
const { Search } = Input;
function MapCurrentAddress(props) {
  console.log(props?.mapsCurrentaddress, "mapssaddresss");
  console.log(props, "propsssss");
  const { isModalCurrentAddressOpen, handleCurrentAddressCancel, handleCurrentAddressOk } = props
  console.log('handleCurrentAddressCancel', handleCurrentAddressCancel)
  ...
  const onMapClick = (mapProps, map, clickEvent) => {
    ...
    props?.handleCurrentAddress(data);
  };
      ...
      .then((data) => {
        if (data.status === "OK" && data.results.length > 0) {
          ...
          if (value === "confirmLocationButton") {
            ...
            props?.handleCurrentAddress(mapsdata, datafromgoogleAPI);
            setSearchResults([])
            handleCurrentAddressCancel()
          }
        } else {
  ...
  return (
    <div>
      <Modal
        ...
        title="Locate On Map"
        open={isModalCurrentAddressOpen}
        onOk={handleCurrentAddressOk}
        onCancel={handleCurrentAddressCancel}
        footer={() => (
          <>
            <Button
              style={{
              ...
              onClick={handleCurrentAddressCancel}
            >
              Cancel
            </Button>
            <Button
